# Del factory evoluciona a Builder
# Permite construir objetos complejos paso a paso
# API pueda crear varios tipos de produccion
# 
# TAQUERIA
...
class TacoHandler(BaseHTTPRequestHandler):
   ...
   def do_POST(self):
      if self.path == "/tacos":
         ...
         #Respuesta  - dic -> transforma en un diccionario
   ...
   def do_PUT(self):
      if self.path.startswith("/tacos/"):
         # Acrualizar por "id" -> despues de "/{id}"
